/* 伊良クレヲル゚語ル漢字音  / Ila-Klé'olr-Ŋǝ́'r Hánzǝ́'im 			
 * 伊良クレオール語の漢字音 / 伊良克里奧爾語漢字音			
 * 			
 * https://note.com/hoenggerbergerin/n/n6a48d644e142 
 * https://www.notion.so/9f28820cf6824f0cbecd566416f98dd2  
 * 			
 * Javascript			
 * 			
 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 			
 * 			
 * 程式ヲ『切韻音系自動推導器』ヘ貼ス入ストナテ、任意デ文章ラ゚イ伊良クレヲル゚語ル漢字音ヲ成ス来スネ。			
 * Deŋşiǝ́ko «Sél'ýn Im'ié Zǝ́dóŋ Şydáuxí» e þévs-naps-to-na te, Ñím'í-de vønçiaŋ-lái Ila-Klé'olr-Ŋǝ́'r hánzǝ́'imó ós-tops-ne. 			
...
const 輕唇化條件 = '幫組 東鍾微虞廢文元歌陽尤凡韻 三等 非 A類';			
...
function 韻母規則() {			
	...
	if (is('廢韻 合口'))      return 'ye';		
			
	// 臻攝		
	if (is('真韻 開口 知組')) return   'rn';		
	if (is('真韻 開口 精組')) return   'ǝn';		
	if (is('真韻 開口'))      return   'iñ';		
	if (is('真韻 幫組'))      return   'iñ';		
	if (is('真韻 合口 知組')) return  'wrn';		
	if (is('真韻 合口 精組')) return   'un';		
	if (is('真韻 合口'))      return   'yñ';		
	if (is('臻韻'))           return   'iñ';		
...
const 訓讀辭書 = {			
	日: ['m',  'it', 'H'],  月: ['t',  'yk', 'H'],  // 天体: 訓讀, 時間: 音讀		
	山: ['h',  'am', 'H'],  海: ['m',  'ǝ',  'L'],  // 通稱: 訓讀, 固有名詞: 音訓各有		
	市: ['t',  'i',  'L'],  野: ['gl', 'uk', 'H'],  // 市場: 訓讀, 都市: 音讀		
	人: ['l',  'aks','L'],  等: ['\'','ra',  'L'],  		
	時: ['þ',  'ǝt', 'L'],  祈: ['n',  'ol', 'L'],		
	成: ['\'', 'os', 'H'],  爲: is('平聲') ? ['\'', 'os', 'L'] : ['', '', ''],  		
	上: ['\'', 'eş', 'H'],  下: ['v',  'ol', 'L'],  		
