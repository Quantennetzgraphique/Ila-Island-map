...
- u /u/: 唇を丸めて「ウ」と発音します。中国語や英語のuと同じ発音です。
- ø /ø/: 唇を丸めて「エ」と発音します。ドイツ語のöやフランス語のeuとœuに近いです。oeとも書きます。
- y /y/: 唇を丸めて「イ」と発音します。中国語やドイツ語のüとフランス語のuと同じ発音です。
- x /x/: 軟口蓋で気流を止まらずに摩擦で「カ行」と発音します。中国語のhやドイツ語のchと同じ発音です。
- ŋ /ŋ/: 鼻濁音で「ガ行」と発音します。英語のngとも同じ発音で、ngとも書きます。
- ç /tɕ/: 「チャ行」で発音します。chとも書きます。
- ş /ɕ/: 「シャ行」で発音します。shとも書きます。
- ñ /ɲ/: 「ニャ行」で発音します。nhとも書きます。
- c /ts/: 「ツァ行」で発音します。
- þ /θ/: 英語の無声音のthのように発音し、thとも書きます。
- q /ʕʷ/: 
- r /ɻ̍/: 中国語のrと同じ発音です。
...
島は禾州（いなす）、浦州（うらす）、灘州（なだす）、鋁州（アルミす）、嶺州（をねす）、津州（つがす）、岬州（みさきす）、峪州（たにす）、硅州（きゑす）、峰州（みねす）、源州（みどす）、鹽州（しをす）の12州からなる。州は市・郡、そして区・邑・郷（日本の区町村に相当）、そして坊・通・町・村（日本の町丁・大字に相当）、そして番・巷・字（日本の番地・小字に相当）に区分されている。番・巷・字の下に番号で住所を特定する。例えば伊良島理研の浦州キャンパスC館の住所は「浦州端原市函城区妙見一坊6番25号」（うらすはたわらしはこしろくみょうけんいちぼうろくばんにじゅうごごう）。

島を大まかに16の都市圏と8つの国立公園にも区分できる。16の都市圏は州庁所在地に加えて汀洲（なぎさす）、豐浦（とようら）、濂溪（れんけい）、鵜泊（うどまり）。8つの国立公園は淺間（あさま/アイシ°キラム）、葦原（あしわら）、上林（じやう゚りむ）、間宮岬（まみやみさき）、奥派水（おくはすい）、藍峴（らんけん）、螢山（ほたるやま）、東濱（ひがしはま）。
...
空港は青湾（あおみ）空港、黄原（きばら）空港、長山（ながやま）空港の3港ある。国際線のみ運航され、浦州ー禾州ー新硅州間の新幹線全通後は国内航空線が全て撤退。
